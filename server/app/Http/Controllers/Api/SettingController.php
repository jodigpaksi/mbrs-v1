...
class SettingController extends Controller
{
    ...
    private const GENERAL_KEYS = [
        ...
        'booking_title_max_length', 'booking_description_max_length',
    ...
    public function generalSettings(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'booking_title_max_length'   => (int) $get('booking_title_max_length', '45'),
            'booking_description_max_length' => (int) $get('booking_description_max_length', '65'),
    ...
    public function updateGeneralSettings(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'booking_title_max_length'  => 'sometimes|integer|min:10|max:255',
            'booking_description_max_length' => 'sometimes|integer|min:10|max:1000',
